#!/usr/bin/env python3
"""
Standalone test for OpenAI models: o3, gpt-4o, and gpt-5
"""
import sys
import os
...
def test_openai_models():
    """Test OpenAI models: o3, gpt-4o, and gpt-5 at temperature 1"""
    print("="*60)
    print("OPENAI MODELS TEST - o3, gpt-4o, gpt-5")
    print("="*60)
