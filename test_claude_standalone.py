#!/usr/bin/env python3
"""
Standalone test for ClaudeAgent real API call
"""
import sys
import os
import time
...
def test_claude_agent_real_api_call():
    ...
    print("="*60)
    print("CLAUDE AGENT REAL API CALL TEST")
    print("="*60)
    ...
    try:
        ...
        if agent.last_reasoning and agent.last_reasoning.strip():
            ...
            print(f"⚠️  No reasoning captured from Claude agent (last_reasoning: {repr(agent.last_reasoning)})")
        ...
        # Test 4: Test different temperature settings (Claude supports 0-1 range)
        print("\n🧪 Test 4: Different temperature settings")
        test_temperatures = [0.2, 0.5, 0.8]  # Claude-specific temperatures
